...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所属学院:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getCollege()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所属专业:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getSpecialName()%></div>
	</div>
	<div class="row bottom15"> 
