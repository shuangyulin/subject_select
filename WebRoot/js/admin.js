		       ...
		       text: "班级管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "ClassInfo/classInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "班级管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ClassInfo/classInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "用户管理",
		       ...
		       text: "题目类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SubjectType/subjectType_add.jsp"
			    	   	},
			    		{
			    	   		text: "题目类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SubjectType/subjectType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "论文题目管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Subject/subject_add.jsp"
			    	   	},
			    		{
			    	   		text: "论文题目管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Subject/subject_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生选题管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SubSelect/subSelect_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生选题管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SubSelect/subSelect_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生成果管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Opus/opus_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生成果管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Opus/opus_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "答辩视频管理",
