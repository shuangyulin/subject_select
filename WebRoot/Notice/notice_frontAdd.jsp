				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="noticeAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="notice_title" class="col-md-2 text-right">新闻标题:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="notice_title" name="notice.title" class="form-control" placeholder="请输入新闻标题">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="notice_content" class="col-md-2 text-right">新闻内容:</label>
						  	 <div class="col-md-8">
...
<script>
//实例化编辑器
var notice_content_editor = UE.getEditor('notice_content'); //新闻内容编辑器
