			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="leavewordAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="leaveword_replyContent" class="col-md-2 text-right">老师回复:</label>
						  	 <div class="col-md-8">
							    <textarea id="leaveword_replyContent" name="leaveword.replyContent" rows="8" class="form-control" placeholder="请输入老师回复"></textarea>
							 </div>
						  </div>
						  <div class="form-group">
