        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>ClassInfo/frontlist">班级</a></li>
                <li><a href="<%=basePath %>UserInfo/frontlist">用户</a></li>
                <li><a href="<%=basePath %>Teacher/frontlist">教师</a></li>
                <li><a href="<%=basePath %>SubjectType/frontlist">题目类型</a></li>
                <li><a href="<%=basePath %>Subject/frontlist">论文题目</a></li>
                <li><a href="<%=basePath %>SubSelect/frontlist">学生选题</a></li>
                <li><a href="<%=basePath %>Opus/frontlist">学生成果</a></li>
                <li><a href="<%=basePath %>Video/frontlist">答辩视频</a></li>
