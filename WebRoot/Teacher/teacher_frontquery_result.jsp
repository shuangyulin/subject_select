...
<%
    ...
    String zhicheng = (String)request.getAttribute("zhicheng"); //教师职称查询关键字
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="teacherQueryForm" id="teacherQueryForm" action="<%=basePath %>Teacher/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="zhicheng" name="zhicheng" value="<%=zhicheng %>" class="form-control" placeholder="请输入教师职称">
			</div>
			<div class="form-group">
