	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_classObj_classNo" class="col-md-2 text-right">所在班级:</label>
				  	 <div class="col-md-8">
					    <select id="userInfo_classObj_classNo" name="userInfo.classObj.classNo" class="form-control">
					    </select>
				  	 </div>
				  </div>
				  <div class="form-group">
